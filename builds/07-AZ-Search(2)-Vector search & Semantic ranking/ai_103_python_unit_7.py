"""
Build 7: Azure AI Search (Part 2) - From Basic Indexing to Semantic Search with Vector Embeddings
...
INDEX_NAME = "build-7-ai-search-index"
...
user_message_text = "What is doccker?"
